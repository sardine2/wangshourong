...
[Environment]::SetEnvironmentVariable("Path","$env:Path;C:\Zoo\Elephant", "sardine2")

运算结果是 Error。再尝试以图像形式查看分支，需要一串代码，比如：      
...
最后我明白事情的关键在于重新设置系统环境变量，敲下 set-location C:\Zoo\Elephant 然后才得以执行。
